          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
            <button
              ...
              style={{
                padding: '10px 8px',
                borderRadius: '12px',
                border: role === 'manager' ? '1px solid #f59e0b' : '1px solid var(--glass-border)',
                background: role === 'manager' ? 'rgba(245,158,11,0.15)' : 'transparent',
                color: role === 'manager' ? '#f59e0b' : 'var(--text-muted)',
                fontWeight: '700',
                fontSize: '13px',
                cursor: 'pointer',
                fontFamily: 'inherit',
            ...
            >
              <Shield size={20} color={role === 'manager' ? '#f59e0b' : 'var(--text-muted)'} />
            ...
            <button
              ...
              style={{
                padding: '10px 8px',
                borderRadius: '12px',
                border: role === 'streamer' ? '1px solid #06b6d4' : '1px solid var(--glass-border)',
                background: role === 'streamer' ? 'rgba(6,182,212,0.15)' : 'transparent',
                color: role === 'streamer' ? '#06b6d4' : 'var(--text-muted)',
                fontWeight: '700',
                fontSize: '13px',
                cursor: 'pointer',
                fontFamily: 'inherit',
            ...
            >
              <Star size={20} color={role === 'streamer' ? '#06b6d4' : 'var(--text-muted)'} />
              <span>مذيع / صانع</span>
            </button>
            ...
            <button
              ...
              style={{
                padding: '10px 8px',
                borderRadius: '12px',
                border: role === 'supervisor' ? '1px solid #8b5cf6' : '1px solid var(--glass-border)',
                background: role === 'supervisor' ? 'rgba(139,92,246,0.15)' : 'transparent',
                color: role === 'supervisor' ? '#8b5cf6' : 'var(--text-muted)',
                fontWeight: '700',
                fontSize: '13px',
                cursor: 'pointer',
                fontFamily: 'inherit',
            ...
            >
              <Award size={20} color={role === 'supervisor' ? '#8b5cf6' : 'var(--text-muted)'} />
